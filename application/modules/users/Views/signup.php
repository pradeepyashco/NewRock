...
<div class="col-lg-12"><h2 class="text-head">General Information</h2></div>
<?php
...
<div class="col-lg-6">
<!--<span class="input input--nao">
  <input class="input__field input__field--nao" type="text" id="user_gender" />
  <label class="input__label input__label--nao" for="user_gender"> <span class="input__label-content input__label-content--nao">Gender</span> </label>
  <svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
  <path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"/>
  </svg> </span>
 -->
...
<div class="col-lg-12 user-profile-box"><h2 class="text-head">User Profile</h2>

<div class="col-lg-6">
<span class="input input--nao">

 <select class="input__field input__field--nao my-down" type="text" id="artist_category" name="artist_category" />
<option value="-1">Artist Category</option>
<?php foreach($categories as $cat): ?>
  ...
  <label class="input__label input__label--nao" for="artist_category"> <span class="input__label-content input__label-content--nao"></span> </label>
  <svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
  <path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"/>
  </svg> </span>
</div>
...
<div class="col-lg-6">
<span class="performer">Live Performer </span>
<span class="performer"> <input type="radio" name="live_performer" id="live_performeryes" value="Yes" <?php echo set_radio('live_performer', 'Yes', TRUE); ?>> &nbsp;Yes </span>
<span class="performer"> <input type="radio" name="live_performer" id="live_performernow" value="No" <?php echo set_radio('live_performer', 'No'); ?>> &nbsp;No </span>
</div>
...
<div class="col-lg-6">
<span class="input input--nao">
  <input class="input__field input__field--nao" type="text" id="distanceliveperformance" name="distanceliveperformance" value="<?php echo set_value('distanceliveperformance'); ?>" />
  <label class="input__label input__label--nao" for="distanceliveperformance"> <span class="input__label-content input__label-content--nao">How far are you willing to travel to perform</span> </label>
  <svg class="graphic graphic--nao" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
  <path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"/>
  </svg> </span>
</div>
...
<input type="hidden" name="latitude" id="map_latitude" value="<?echo set_value('map_latitude'); ?>" />
<input type="hidden" name="longitude" id="map_longitude" value="<?echo set_value('map_longitude'); ?>" />
<input type="hidden" name="fanzip" id="fanzip" value="<?echo set_value('fanzip'); ?>" />
